...
class Pessoa extends TRecord
{
    ...
    public function onBeforeDelete()
    {
        ...
        if(PessoaGrupo::where('pessoa_id', '=', $this->id)->first())
        {
        ...
        if(PessoaContato::where('pessoa_id', '=', $this->id)->first())
        {
            throw new Exception("Não é possível deletar este registro pois ele está sendo utilizado em outra parte do sistema");
        }
    
        if(OrdemServico::where('cliente_id', '=', $this->id)->first())
        {
            throw new Exception("Não é possível deletar este registro pois ele está sendo utilizado em outra parte do sistema");
        }
    
        if(OrdemServicoAtendimento::where('tecnico_id', '=', $this->id)->first())
        {
            throw new Exception("Não é possível deletar este registro pois ele está sendo utilizado em outra parte do sistema");
        }
    
        if(Conta::where('pessoa_id', '=', $this->id)->first())
        {
            throw new Exception("Não é possível deletar este registro pois ele está sendo utilizado em outra parte do sistema");
        }
