...
class CategoriaHeaderList extends TPage
{
    ...
    public function __construct($param = null)
    {
        ...
        $tipo_conta_id = new TDBCombo('tipo_conta_id', 'moraisjr_eti', 'TipoConta', 'id', '{nome}','nome asc' , $criteria_tipo_conta_id );
        ...
        $column_tipo_conta_nome = new TDataGridColumn('tipo_conta->nome', "Tipo conta id", 'left');
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["FINACEIRO","Categorias"]));
        }
