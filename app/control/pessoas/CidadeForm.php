...
class CidadeForm extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        $id = new TEntry('id');
        $estado_id = new TDBCombo('estado_id', 'moraisjr_eti', 'Estado', 'id', '{nome}','nome asc' , $criteria_estado_id );
        ...
        $row1 = $this->form->addFields([new TLabel("Id:", null, '14px', null, '100%'),$id],[new TLabel("Estado id:", '#ff0000', '14px', null, '100%'),$estado_id]);
