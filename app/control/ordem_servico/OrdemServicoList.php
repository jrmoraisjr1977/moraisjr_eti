...
class OrdemServicoList extends TPage
{
    ...
    public function __construct($param = null)
    {
        ...
        $this->form->setFormTitle("Listagem de ordem servicos");
        $this->limit = 20;
        ...
        $data_prevista_prevista = new TDate('data_prevista_prevista');
        ...
        $data_prevista_prevista->setMask('dd/mm/yyyy');
        ...
        $data_prevista_prevista->setDatabaseMask('yyyy-mm-dd');
        ...
        $data_prevista_prevista->setSize(110);

        $row1 = $this->form->addFields([new TLabel("Id:", null, '14px', null, '100%'),$id],[new TLabel("Cliente:", null, '14px', null, '100%'),$cliente_id]);
        $row1->layout = ['col-sm-6','col-sm-6'];

        $row2 = $this->form->addFields([new TLabel("Descricao:", null, '14px', null, '100%'),$descricao],[new TLabel("Data de inicio:", null, '14px', null, '100%'),$data_inicio,new TLabel("até", null, '14px', null),$data_inicio_fim]);
        $row2->layout = ['col-sm-6','col-sm-6'];

        $row3 = $this->form->addFields([new TLabel("Data fim:", null, '14px', null, '100%'),$data_fim,new TLabel("até", null, '14px', null),$data_fim_fim],[new TLabel("Data prevista:", null, '14px', null, '100%'),$data_prevista,new TLabel("até", null, '14px', null),$data_prevista_prevista]);
        ...
        $btn_onshow = $this->form->addAction("Cadastrar", new TAction(['OrdemServicoForm', 'onShow']), 'fas:plus #69aa46');
        ...
        $column_data_inicio = new TDataGridColumn('data_inicio', "Data de inicio", 'left');
        $column_data_fim = new TDataGridColumn('data_fim', "Data fim", 'left');
        $column_data_prevista = new TDataGridColumn('data_prevista', "Data prevista", 'left');
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["ORDEM SERVICO","Ordem servicos"]));
        }
    ...
    public function onSearch($param = null)
    {
        ...
        if (isset($data->data_prevista_prevista) AND ( (is_scalar($data->data_prevista_prevista) AND $data->data_prevista_prevista !== '') OR (is_array($data->data_prevista_prevista) AND (!empty($data->data_prevista_prevista)) )) )
        {

            $filters[] = new TFilter('data_prevista', '<=', $data->data_prevista_prevista);// create the filter 
        }
