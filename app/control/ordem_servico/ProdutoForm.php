...
class ProdutoForm extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        $id = new TEntry('id');
        $tipo_produto_id = new TDBCombo('tipo_produto_id', 'moraisjr_eti', 'TipoProduto', 'id', '{nome}','nome asc' , $criteria_tipo_produto_id );
        ...
        $nome->setSize('100%');
        $preco->setSize('100%');
        $foto->setSize('100%', 140);
        $tipo_produto_id->setSize('100%');
        $observacao->setSize('100%', 140);
        ...
        $row3 = $this->form->addFields([new TLabel("Nome:", '#ff0000', '14px', null, '100%'),$nome],[new TLabel("Preco:", '#ff0000', '14px', null, '100%'),$preco]);
        $row3->layout = ['col-sm-6','col-sm-6'];

        $row4 = $this->form->addFields([new TLabel("Observacao:", null, '14px', null, '100%'),$observacao],[new TLabel("Foto:", null, '14px', null, '100%'),$foto]);
